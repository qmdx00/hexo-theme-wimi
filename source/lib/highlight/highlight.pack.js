...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},s]}}}());hljs.registerLanguage("c-like",function(){"use strict";return function(e){
...
return{name:"Plain text",aliases:["text","txt"],disableAutodetect:!0}}}());hljs.registerLanguage("lua",function(){"use strict";return function(e){
...
begin:t,end:a,contains:[n],relevance:5}])}}}());hljs.registerLanguage("go",function(){"use strict";return function(e){var n={
...
begin:/\(/,end:/\)/,keywords:n,illegal:/["']/}]}]}}}());hljs.registerLanguage("python",function(){"use strict";return function(e){
const n={
...
contains:null,skip:!0})]}]}}}());hljs.registerLanguage("properties",function(){"use strict";return function(e){
...
relevance:0}],starts:r},{className:"attr",relevance:0,begin:s+n+"$"}]}}}());hljs.registerLanguage("ruby",function(){"use strict";return function(e){
var n="[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?",a={
...
contains:b}}}());hljs.registerLanguage("scss",function(){"use strict";return function(e){
...
},i,e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,r,e.CSS_NUMBER_MODE]}]}}}());hljs.registerLanguage("ini",function(){"use strict";function e(e){
...
starts:{end:/$/,contains:[i,c,r,t,l,s]}}]}}}());hljs.registerLanguage("http",function(){"use strict";return function(e){
...
begin:"{",end:"}",illegal:/\S/,contains:[e.C_BLOCK_COMMENT_MODE,n]}]}}}());hljs.registerLanguage("rust",function(){"use strict";return function(e){
...
},{begin:e.IDENT_RE+"::",keywords:{built_in:t}},{begin:"->"}]}}}());hljs.registerLanguage("javascript",function(){"use strict"
...
illegal:"[^\\s\\}]"}}}());hljs.registerLanguage("bash",function(){"use strict";return function(e){
...
name:"JSON",contains:t,keywords:e,illegal:"\\S"}}}());hljs.registerLanguage("perl",function(){"use strict";return function(e){var n={
$pattern:/[\w.]+/,
...
contains:a}}}());hljs.registerLanguage("swift",function(){"use strict";return function(e){var i={
...
},{beginKeywords:"import",end:/$/,contains:[e.C_LINE_COMMENT_MODE,n]}]}}}());hljs.registerLanguage("objectivec",function(){"use strict";return function(e){
...
begin:"\\."+e.UNDERSCORE_IDENT_RE,relevance:0}]}}}());hljs.registerLanguage("csharp",function(){"use strict";return function(e){
var n={
...
i.name="C++",i.aliases=["cc","c++","h++","hpp","hh","hxx","cxx"],i}}());hljs.registerLanguage("typescript",function(){"use strict"
;const e="[A-Za-z$_][0-9A-Za-z$_]*",n=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],a=["true","false","null","undefined","NaN","Infinity"],s=[].concat(["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],["arguments","this","super","console","window","document","localStorage","module","global"],["Intl","DataView","Number","Math","Date","String","RegExp","Object","Function","Boolean","Error","Symbol","Set","Map","WeakSet","WeakMap","Proxy","Reflect","JSON","Promise","Float64Array","Int16Array","Int32Array","Int8Array","Uint16Array","Uint32Array","Float32Array","Array","Uint8Array","Uint8ClampedArray","ArrayBuffer"],["EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"])
...
name:"TypeScript",aliases:["ts"]}),g}}());hljs.registerLanguage("java",function(){"use strict";function e(e){
...
excludeBegin:!0,end:t+":",relevance:0}],illegal:/#|<\//};var l}}());hljs.registerLanguage("sql",function(){"use strict";return function(e){
